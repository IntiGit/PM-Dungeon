...
public class ItemFactory {
    ...
    private final List<ItemData> allItems =
        List.of(
            new Waffe(
                ItemType.Passive,
                new Animation(List.of("itemTextures/weapons/rustyBlade/rostigeKlinge.png"), 1),
                new Animation(List.of("itemTextures/weapons/rustyBlade/rostigeKlinge.png"), 1),
                "Rostige Klinge",
            ...
            new Waffe(
                ItemType.Passive,
                new Animation(List.of("itemTextures/weapons/jadeBlade/jadeKlinge.png"), 1),
                new Animation(List.of("itemTextures/weapons/jadeBlade/jadeKlinge.png"), 1),
                "Jade Klinge",
            ...
            new Trank(
                ItemType.Active,
                new Animation(List.of("itemTextures/potions/lilaGebraeu/lilaGebraeu.png"), 1),
                new Animation(List.of("itemTextures/potions/lilaGebraeu/lilaGebraeu.png"), 1),
                "Lila Gebräu",
            ...
            new Schuhe(
                ItemType.Passive,
                new Animation(List.of("itemTextures/shoes/dickeTreter/dickeTreter.png"), 1),
                new Animation(List.of("itemTextures/shoes/dickeTreter/dickeTreter.png"), 1),
                "Dicke Treter",
                "Schuhe die sich zum zertreten von Fallen eignen"),
            new Schuhe(
                ItemType.Passive,
                new Animation(List.of("itemTextures/shoes/nochDickereTreter/nochDickereTreter.png"), 1),
                new Animation(List.of("itemTextures/shoes/nochDickereTreter/nochDickereTreter.png"), 1),
                "Noch dickere Treter",
